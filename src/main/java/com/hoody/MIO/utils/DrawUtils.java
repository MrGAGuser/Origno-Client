...
public class DrawUtils {
    ...
    private static void drawLine(WorldRenderer bufferBuilder, BlockPos pos, BlockPos nextPos) {
        bufferBuilder.pos(pos.getX() + 0.5f, pos.getY() + 0.5f, pos.getZ() + 0.5f).color(GhosterBuster.config.aotvRouteLineColor.getRed() / 255f, GhosterBuster.config.aotvRouteLineColor.getGreen() / 255f, GhosterBuster.config.aotvRouteLineColor.getBlue() / 255f, GhosterBuster.config.aotvRouteLineColor.getAlpha() / 255f).endVertex();
        bufferBuilder.pos(nextPos.getX() + 0.5f, nextPos.getY() + 0.5f, nextPos.getZ() + 0.5f).color(GhosterBuster.config.aotvRouteLineColor.getRed() / 255f, GhosterBuster.config.aotvRouteLineColor.getGreen() / 255f, GhosterBuster.config.aotvRouteLineColor.getBlue() / 255f, GhosterBuster.config.aotvRouteLineColor.getAlpha() / 255f).endVertex();
    }

    private static void drawLine(WorldRenderer bufferBuilder, Vec3 pos, Vec3 nextPos) {
        bufferBuilder.pos(pos.xCoord, pos.yCoord, pos.zCoord).color(GhosterBuster.config.aotvRouteLineColor.getRed() / 255f, GhosterBuster.config.aotvRouteLineColor.getGreen() / 255f, GhosterBuster.config.aotvRouteLineColor.getBlue() / 255f, GhosterBuster.config.aotvRouteLineColor.getAlpha() / 255f).endVertex();
        bufferBuilder.pos(nextPos.xCoord, nextPos.yCoord, nextPos.zCoord).color(GhosterBuster.config.aotvRouteLineColor.getRed() / 255f, GhosterBuster.config.aotvRouteLineColor.getGreen() / 255f, GhosterBuster.config.aotvRouteLineColor.getBlue() / 255f, GhosterBuster.config.aotvRouteLineColor.getAlpha() / 255f).endVertex();
    }

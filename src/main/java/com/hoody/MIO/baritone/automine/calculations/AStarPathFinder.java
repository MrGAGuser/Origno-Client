package com.jelly.GhosterBuster.baritone.automine.calculations;

import com.jelly.GhosterBuster.GhosterBuster;
import com.jelly.GhosterBuster.baritone.automine.logging.Logger;
import com.jelly.GhosterBuster.baritone.automine.calculations.behaviour.PathFinderBehaviour;
import com.jelly.GhosterBuster.baritone.automine.calculations.behaviour.PathMode;
import com.jelly.GhosterBuster.baritone.automine.calculations.exceptions.NoBlockException;
import com.jelly.GhosterBuster.baritone.automine.calculations.exceptions.NoPathException;
import com.jelly.GhosterBuster.baritone.automine.structures.*;
import com.jelly.GhosterBuster.handlers.MacroHandler;
import com.jelly.GhosterBuster.utils.AngleUtils;
        ...
        if (MacroHandler.macros.get(0).isEnabled()) {
            ...
            for (BlockNode node : nodes) {
                if (MacroHandler.macros.get(2).isEnabled()) {
                    if (MineUtils.getMithrilColorBasedOnPriority(GhosterBuster.config.mithPriority4).stream().anyMatch(blockData -> BlockUtils.isBlock(blockData, node.getPos()))) {
                    ...
                    } else if (MineUtils.getMithrilColorBasedOnPriority(GhosterBuster.config.mithPriority3).stream().anyMatch(blockData -> BlockUtils.isBlock(blockData, node.getPos()))) {
                    ...
                    } else if (MineUtils.getMithrilColorBasedOnPriority(GhosterBuster.config.mithPriority2).stream().anyMatch(blockData -> BlockUtils.isBlock(blockData, node.getPos()))) {

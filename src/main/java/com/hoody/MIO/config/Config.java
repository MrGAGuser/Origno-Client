package com.jelly.GhosterBuster.config;
...
import com.jelly.GhosterBuster.hud.MobKillerHUD;
import com.jelly.GhosterBuster.hud.CommissionMacroHUD;
...
public class Config extends cc.polyfrost.oneconfig.config.Config {
    ...
    public Config() {
        super(new Mod("GhosterBuster9000", ModType.HYPIXEL, new VigilanceMigrator("mightyminer.toml")), "/mightyminer/config.json");
        initialize();

...
public class MithrilMacro extends Macro {
    ...
    protected void onEnable() {
        ...
        if (GhosterBuster.config.playerFailsafe) {
            if (PlayerUtils.isNearPlayer(GhosterBuster.config.playerRad)) {
    ...
    private ArrayList<ArrayList<BlockData<?>>> getPriorityList() {
        ...
        priorityList.add(MineUtils.getMithrilColorBasedOnPriority(GhosterBuster.config.mithPriority1));
        priorityList.add(MineUtils.getMithrilColorBasedOnPriority(GhosterBuster.config.mithPriority2));
        priorityList.add(MineUtils.getMithrilColorBasedOnPriority(GhosterBuster.config.mithPriority3));
        priorityList.add(MineUtils.getMithrilColorBasedOnPriority(GhosterBuster.config.mithPriority4));
    ...
    private BaritoneConfig getMineBehaviour() {
        return new BaritoneConfig(
                MiningType.STATIC,
                GhosterBuster.config.mithShiftWhenMine,
                true,
                false,
                GhosterBuster.config.mithRotationTime,
                GhosterBuster.config.mithRestartTimeThreshold,
                null,
                null,
                256,
                0

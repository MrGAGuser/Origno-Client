...
public class GemstoneMacro extends Macro {
    ...
    public void onTick(TickEvent.Phase phase){
        ...
        if(!haveTreasureChest) {
            switch(baritone.getState()){
                case IDLE:
                    baritone.mineFor(MineUtils.getGemListBasedOnPriority(GhosterBuster.config.gemGemstoneType));
                    break;
                case FAILED:
    ...
    public void onMessageReceived(String message){
        ...
        if(message.contains("You uncovered a treasure chest!") && GhosterBuster.config.gemOpenChest){
    ...
    private BaritoneConfig getMineBehaviour(){
        return new BaritoneConfig(
                ...
                true,
                false,
                GhosterBuster.config.gemRotationTime,
                GhosterBuster.config.gemRestartTimeThreshold,
                null,
                blocksAllowedToMine,
                GhosterBuster.config.gemMaxY,
                GhosterBuster.config.gemMinY
        );
    }

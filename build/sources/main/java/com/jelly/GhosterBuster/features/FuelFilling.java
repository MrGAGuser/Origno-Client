...
public class FuelFilling {
    ...
    public void onTick(TickEvent event) {
        if (!GhosterBuster.config.refuelWithAbiphone || mc.thePlayer == null) return;
    ...
    public void onTickSecond(TickEvent.ClientTickEvent event) {
        ...
        if (!(fuel != -1 && fuel < GhosterBuster.config.refuelThreshold)) return;
        ...
        switch (currentState) {
            ...
            case WAITING: {
                ...
                if (abiphoneIndex == -1) {
                    ...
                    currentState = states.NONE;
                    GhosterBuster.config.refuelWithAbiphone = false;
                    Reset();
                    return;
                }
            ...
            case REFILLING_FUEL: {
                ...
                if (mc.thePlayer.openContainer instanceof ContainerChest) {
                    ...
                    switch (GhosterBuster.config.typeOfFuelIndex) {
                        case 0: {
                            fuelName = "goblin egg";
                            break;
                        }

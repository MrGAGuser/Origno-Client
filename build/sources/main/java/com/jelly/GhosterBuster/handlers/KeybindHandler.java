...
import com.jelly.GhosterBuster.baritone.automine.config.WalkBaritoneConfig;
...
import com.jelly.GhosterBuster.utils.Utils.ReflectionUtils;
...
public class KeybindHandler {
    ...
    public static void initializeCustomKeybindings() {
        macroKeybinds[0] = new KeyBinding("Start/Stop macro", Keyboard.KEY_F, "GhosterBuster");
        macroKeybinds[1] = new KeyBinding("Debug", Keyboard.KEY_H, "GhosterBuster");
        macroKeybinds[2] = new KeyBinding("Open GUI", Keyboard.KEY_RSHIFT, "GhosterBuster");
    ...
    public void onKeyPress(InputEvent.KeyInputEvent event) {
        ...
        if(macroKeybinds[0].isKeyDown()){
            if (MacroHandler.macros.stream().anyMatch(Macro::isEnabled))
                ...
                MacroHandler.startScript(GhosterBuster.config.macroType);
        }
